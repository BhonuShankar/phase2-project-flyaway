...
<style>
body {
    background-image: url("https://www.slideteam.net/media/catalog/product/cache/1280x720/w/h/white_background_with_aeroplane_and_travel_stock_photo_Slide01.jpg");
}
</style>
<h1>FlyAway</h1>
